...
class Ventana(Frame):
	...
	def obtener_tiempo(self):
		...
		#API = https://api.openweathermap.org/data/2.5/weather?id={city id}&appid={API key}
	...
	def widgets(self):
		...
		self.imagen_temp = PhotoImage(file ='clima.png')
		self.imagen_temp_min = PhotoImage(file ='menor.png')
		self.imagen_temp_max = PhotoImage(file ='mayor.png')
		...
		Label(self.frame7,text='PresiÃ³n' , bg='sky blue').pack(expand=True)
